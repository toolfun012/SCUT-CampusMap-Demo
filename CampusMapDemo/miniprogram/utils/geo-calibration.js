// GCJ-02 to campus-map pixel calibration for SCUT University Town campus.
// wx.getLocation({ type: "gcj02" }) returns the same coordinate system.
//
// Gate anchors use AMap/GCJ-02 POIs matched to the user-confirmed official
// campus-map pixels. Keep using GCJ-02 here because wx.getLocation({ type:
// "gcj02" }) returns the same coordinate system.
